    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-3xl font-bold text-[#1f2462]">
        ...
        {/* Explore Button */}
        <Link href={`/projects/${propertyId}`}>
          <button className="w-full border-2 border-[#9C27B0] text-[#9C27B0] font-medium py-3 px-6 rounded-lg hover:bg-[#9C27B0] hover:text-white transition-colors">
            Explore Now
          </button>
        </Link>
      </div>
